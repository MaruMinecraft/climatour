...
export const dictionaries = {
  ru: {
    ...
    phoneError: "Введите корректный номер телефона (например +79991234567 или 89991234567).",
    ...
    comparisonTitle: "Сравнение туров",
    comparisonHotel: "Отель",
    comparisonDuration: "Длительность",
    comparisonIncluded: "Включено",
    comparisonScenarios: "Сценарии",
    comparisonTemp: "Средняя температура",
    comparisonRain: "Вероятность дождя",
    comparisonWind: "Ветер",
    comparisonHumidity: "Влажность",
    comparisonPricePerNight: "Цена за ночь",
    comparisonValueRating: "Соотношение цена / условия",
    comparisonPros: "Плюсы",
    comparisonCons: "Минусы",
    comparisonWeatherVerdict: "Погодный вывод",
    weatherLive: "Онлайн"
  },
  en: {
    appName: "Climatour",
    ...
    phoneError: "Enter a valid phone number (e.g. +79991234567 or 89991234567).",
    ...
    comparisonTitle: "Tour Comparison",
    comparisonHotel: "Hotel",
    comparisonDuration: "Duration",
    comparisonIncluded: "Included",
    comparisonScenarios: "Scenarios",
    comparisonTemp: "Avg temperature",
    comparisonRain: "Rain probability",
    comparisonWind: "Wind",
    comparisonHumidity: "Humidity",
    comparisonPricePerNight: "Price per night",
    comparisonValueRating: "Price / quality ratio",
    comparisonPros: "Pros",
    comparisonCons: "Cons",
    comparisonWeatherVerdict: "Weather verdict",
    weatherLive: "Live"
  }
} as const;
